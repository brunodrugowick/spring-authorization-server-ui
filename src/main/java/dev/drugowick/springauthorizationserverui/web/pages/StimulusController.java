...
public class StimulusController extends BasePageController {

    private final UserRepository userRepository;
    private final ClientRepository clientRepository;

    @RequestMapping(path = "/stimulus-index.html")
    public String getStimulusHome() {
        return "stimulus/stimulus-index";
    }
